...
const CollagePhoto = () => {
  ...
  return (
    <div className="content">
      <h2>2 Photo Collage Acrylic Wall Photo</h2>
      <div
      ...
      >
        <div className="small-img" data-slot="1">
          <img className="previewImage" id="previewImage1"  alt="Click to upload" style={{ display: "none" }} />
          <input type="file" id="fileInput1" accept="image/*" style={{ display: "none" }} />
          <p className="placeholderText">
            <i className="fa-solid fa-upload"></i> Upload
          </p>
        </div>
        <div className="small-img" data-slot="2">
          <img className="previewImage" id="previewImage2"  alt="Click to upload" style={{ display: "none" }} />
      ...
      <button className="upload-btn download" id="downloadBtn">

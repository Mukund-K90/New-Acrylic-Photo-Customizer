...
function initializeImageFeatures(imageElement) {
    ...
    makeDraggable(imageElement, { resize: 'afm-resize', rotate: 'afm-rotate' });
}

function addResizeHandle(imageElement) {
    const resizeHandle = document.createElement('div');
    resizeHandle.className = 'afm-resize';
    resizeHandle.style.position = 'absolute';
    resizeHandle.style.right = '55%';
    resizeHandle.style.bottom = '12%';
    resizeHandle.style.cursor = 'nwse-resize';
    resizeHandle.style.fontWeight
